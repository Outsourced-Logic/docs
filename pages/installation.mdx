...
2. 🌐 **Download**: Click the link to the [MultiOn Chrome Extension](https://drive.google.com/file/d/1gu546V6XrXNNgUXDk8YuytFW5Z8gz-lk/view?usp=sharing) (Psst! If you encounter a 404 error, it means the team is working their magic to authorize your email). Download and unzip the build file. 

3. 🚀 Go to Chrome Browser and click extentions -> Turn on developer mode, tap load unpacked and select the build file
