...
<center>
  ...
  <img
    src="./alert_box.png"
    alt="alert_box"
    style={{ width: "547px", height: "200px", borderWidth: "50%" }}
  />{" "}
</center>

## Manually Upgrading MultiOn

Follow these simple steps to stay at the cutting edge and use the latest MultiOn agent.
...
- Click "Remove from Chrome" to uninstall the existing version.
  ...
  <center>
    ...
    <img
      ...
      style={{ width: "175px", height: "36px", borderWidth: "50%" }}
    />{" "}
  </center>
